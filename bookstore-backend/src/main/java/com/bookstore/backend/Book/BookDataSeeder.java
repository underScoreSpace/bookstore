...
public class BookDataSeeder implements CommandLineRunner {
    ...
    private List<BookInfo> getBookList() {
        return List.of(
                ...
                new BookInfo("Patterns of Enterprise Application Architecture", "Martin Fowler", "Covers proven patterns for building robust, large-scale enterprise applications.", "9780321127426"),
                ...
                new BookInfo("Programming Rust", "Jim Blandy and Jason Orendorff", "A deep dive into Rust for building fast, safe, and concurrent systems.", "9781491927281"),
                new BookInfo("Go Programming Blueprints", "Mat Ryer", "Practical projects and design examples written in the Go programming language.", "978-1786468949"),
